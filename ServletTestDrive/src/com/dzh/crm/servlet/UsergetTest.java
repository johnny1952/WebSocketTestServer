 ...
 * userget请求:
 * 
 * http://xxx.xxx.xxx.xxx/AccService/AccServlet.do?method=userget&uname
=xxxx&dwComputerIDLow=xxxx&dwComputerIDHigh=xxxx&dwMachineRand=xxxx&
exreq=xxxx&encoding=xxxx&appid=xx&token=xxxx

或者：
http://xxx.xxx.xxx.xxx/AccService/AccServlet.do?method=userget&uname=xxxx
 * @throws SAXException 
 * @throws IOException 
 */
	@Test
	public void testUserget() throws IOException, SAXException {
		...
		//1&uname=LVTA3850074&upass=182399&usertid=15835027
		String urlString = "http://10.15.108.114:9001/AccService/AccServlet.do?method=userget&uname=LVTA3850067";
	...
	public void testUnameNull() throws IOException, SAXException {
		...
		WebConversation  	web = new WebConversation(); 
		String urlString = "http://10.15.108.114:9001/AccService/AccServlet.do?method=userget&uname=";
		GetMethodWebRequest get = new GetMethodWebRequest(urlString);
		WebResponse response = web.getResponse(get);  
		System.out.printf("text : %s", response.getText());  
